...
TOKEN='AQAAAABFKV7dAAT7o4We_t87d0pknjdXjGiJWs0'
#SKILL='6af03329-a55e-4184-bc9e-0c563f496849'
SKILL='7f4c6290-2055-4c3a-926c-5a9a6ef53298'
...
if __name__ == '__main__':
    yandex = YandexImages()
    yandex.set_auth_token(token = 'AQAAAABFKV7dAAT7o4We_t87d0pknjdXjGiJWs0')
    print(yandex.SESSION.headers)
    yandex.skills = '7f4c6290-2055-4c3a-926c-5a9a6ef53298'
    print(yandex.checkOutPlace())
    print(yandex.downloadImageFile('bike.jpg'))
